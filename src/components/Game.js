...
export default function Game() {
  ...
  return (
    <section className='flex items-center justify-center'>
      <div className="bg-white p-8 rounded-lg shadow-lg min-w-[80vw] md:min-w-[30rem]">
        ...
        {resultado && (
          <p
            className={`mt-4 p-3 rounded ${resultado.includes('Felicidades') ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
              }`}
          >
            {resultado}
          </p>
